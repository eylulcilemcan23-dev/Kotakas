...
apiRouter.get('/migration-status', (_req, res) => {
  res.json({
    ...
    next: [
      'choose and implement real payment provider checkout/webhook adapter',
      'staging database schema confirmation including payment migration',
      'production-compatible listings/disputes/audit/communications/swaps/payment migration verification',
      'market, escrow, swap, dispute, communication, payment and audit write activation in staging',
